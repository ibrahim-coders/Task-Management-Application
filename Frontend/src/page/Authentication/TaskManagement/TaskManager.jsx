...
import ToDo from '../../TaksList/ToDo';
import Complete from '../../TaksList/Complete';
  ...
  return (
    <>
      <div className="w-full grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-4 relative mb-8">
            ...
            >
              ...
              <div>
                ...
                <div className="absolute bottom-3  right-3 gap-2 flex justify-center items-end">
                  <button
                    ...
                    className={`${
                      task.status === 'To-Do'
                        ? ' transition cursor-pointer  text-sm small-btn bg-blue-600 text-white'
              ...
              {openModals[task._id] && (
                <div className="absolute top-0 left-0 w-full bg-white shadow-lg p-4 rounded-md z-10">
                  ...
                  <label className="block mb-1 mt-4 text-sm ">
                    Description
                  </label>
                  <textarea
        ...
        <div className="w-full md:w-72 h-44">
          <ToDo />
        </div>
        <div className="w-full md:w-72 h-44">
          <Complete />
