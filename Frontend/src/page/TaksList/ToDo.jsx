            ...
            <div>
              ...
              <div className="absolute bottom-3  right-3 gap-2 flex justify-center items-end">
                <button
                  ...
                  className={`${
                    task.status === 'To-Do'
                      ? ' transition cursor-pointer  text-sm p-2 bg-blue-500 rounded-md'
                      : task.status === 'In Progress'
                      ? 'bg-orange-500 text-white transition cursor-pointer small-btn'
                      : task.status === 'Done'
                      ? 'text-green-500  transition cursor-pointer  text-sm p-2 rounded-md'
                      : ''
                  }`}
                >
                  {task.status}
